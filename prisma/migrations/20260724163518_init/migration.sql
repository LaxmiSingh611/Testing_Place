...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('MOCK_CARD', 'MOCK_UPI', 'COD');
...
CREATE TABLE "Payment" (
    "id" TEXT NOT NULL,
    "orderId" TEXT NOT NULL,
    "method" "PaymentMethod" NOT NULL DEFAULT 'MOCK_CARD',
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_mockReference_key" ON "Payment"("mockReference");
